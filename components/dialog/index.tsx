				...
				{!hasWallet && (
					<>
						...
						<p role="caption" tabIndex={0}>
							Wallet not found. Please{' '}
							<a
								data-href="https://support.metamask.io/hc/en-us/articles/360015489531-Getting-started-with-MetaMask"
								target="_blank"
								tabIndex={0}
								role="link"
							>
							...
							to know more about Getting started with Metamask.
						</p>
					</>
				)}
